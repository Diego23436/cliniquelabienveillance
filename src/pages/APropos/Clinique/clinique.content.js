...
export const content = {
  fr: {
    ...
    intro:
      'La Clinique La Bienveillance est un centre de santé communautaire basé à Douala, dédié à des soins accessibles, humains et disponibles à toute heure du jour et de la nuit. Deux sites sont présentés clairement pour faciliter votre venue.',
    ...
    insurancesTitle: 'Assurances acceptées',
    insurancesIntro: 'Nous travaillons avec des partenaires d’assurance reconnus pour faciliter votre prise en charge médicale.',
    insurances: [
      { name: 'Royal Onyx Assurance', logo: '/insurances/royal-onyx.png' },
      { name: 'Activa Assurance', logo: '/insurances/activa-assurance.png' },
      { name: 'Saham/Allianz Assurance', logo: '/insurances/saham-allianz.png' },
      { name: 'Generalia Assurance', logo: '/insurances/generalia-assurance.png' },
    ],
  ...
  en: {
    ...
    title: 'Our Clinic',
    intro:
      'Clinique La Bienveillance is a community health center based in Douala, dedicated to accessible, human-centered care available around the clock. Two locations are clearly presented to make visiting easier.',
    ...
    insurancesTitle: 'Accepted Insurances',
    insurancesIntro: 'We work with recognized insurance partners to make your medical coverage more secure and reliable.',
    insurances: [
      { name: 'Royal Onyx Assurance', logo: '/insurances/royal-onyx.png' },
      { name: 'Activa Assurance', logo: '/insurances/activa-assurance.png' },
      { name: 'Saham/Allianz Assurance', logo: '/insurances/saham-allianz.png' },
